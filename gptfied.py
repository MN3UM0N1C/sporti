...
class FootballerScraper:
    def __init__(self, user_input):
        ...
        #     "Cookie": "asdasj udv u %00ejj{}}}%a0ee"
        # }
        ...
        if teams:
            ...
            for k in names_list:
                names.append(
                    k.text)
        if not_all:
            return json.dumps({"Live information": dict(zip(names, self.parse_little(teams)))})
...
if __name__ == "__main__":
    scraper = FootballerScraper("lebron james")
    #print(scraper.statistics())
    print(scraper.names(False, True))


#can you minify and make output json more compact?
