...
class FootballDataDownloader:
    def __init__(self, league_id_mapping):
        ...
        self.base_url = "https://www.goalserve.com/getfeed/401117231212497fb27a08db8de47c17/getodds/soccer?cat=basket_10&League="
...
if __name__ == "__main__":
    ...
    football_downloader = FootballDataDownloader(baskeball_id_mapping)
